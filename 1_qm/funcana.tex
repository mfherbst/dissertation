...
\todoil{Which field \ldots clearify or move statement}ü
...
\begin{rem}
	\todoil{Here spinor and spin are introduced rather ad hoc,
...
has to be.
\todoil{One gets lost in the mathematics by now \ldots add some forward references}
