...
\subsection{General remarks about basis functions}
Why can we not use everything?
Issue with evaluating the integrals


\subsection{Employing Slater-type orbitals}
\defineabbr{STO}{STO\xspace}{Slater-type orbtital}

\subsection{Employing a contracted Gaussian basis}
\todo[inline,caption={}]{
	\begin{itemize}
...
\subsection{Employing a Finite Element basis}
\todo[inline,caption={}]{
	\begin{itemize}
...
\subsection{Employing a Coulomb-Sturmian basis}
\label{sec:BasisCS}
