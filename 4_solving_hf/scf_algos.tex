...
but also used this measure to suggest an acceleration scheme
for the \SCF procedure now known
...
where
the error matrices $\{\mat{e}^{(n-i)}\}_{i=0,\ldots,m-1}$
...
\begin{itemize}
	...
	\item Build the Fock matrix $\tilde{\mat{F}}$
