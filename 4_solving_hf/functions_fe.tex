...
or \newterm{atom-centred orbital}s~({\ACO}s).
...
Assuming $\Nquadc$ to be large enough,
...
In other words the quadrature itself only to be defined
...
I would not expect this attempt to beneficial by its own
...
Due to these challenges a practically useful implmentation
