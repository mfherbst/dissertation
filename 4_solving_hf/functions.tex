...
\defineabbr{cGTO}{cGTO\xspace}{Contracted Gaussian-type orbitals}
\defineabbr{GTO}{GTO\xspace}{Gaussian-type orbitals}
\defineabbr{STO}{STO\xspace}{Slater-type orbitals}
...
\defineabbr{FE}{FE\xspace}{Finite elements}
