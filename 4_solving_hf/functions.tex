...
which by itself represents the physics of electronic structure theory very well
...
Related to the relative residual
\[ \frac{\Op{H} \Phi - E_0 \Phi}{\Phi} = E_L - E_0 \]

Sensible to define total local energy (i.e. integral over it)
