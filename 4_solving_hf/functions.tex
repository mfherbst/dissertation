...
already gives an overview of the functions,
...
where, similar to the finite-element method mentioned above,
...
are cases, where more than one type of basis function is employed at once.
For example SIESTA uses two discretisations at once
--- one in terms of {\cGTO}s as well as a numerical grid ---
and projects back and forth between them,
...
but computing the electron repulsion integrals efficiently
would, in my opinion, be a rather involved tasks.
