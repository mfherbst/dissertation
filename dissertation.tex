...
\usepackage[disable]{todonotes}    % For in-document notes (disabled)
...
% Include info about the git repo
\input{gitcommit}
...
\subimport{42_appendix/} {appendix}
\input{biblio}
\input{publications}
\subimport{99_acknowledgements/}{main}
\input{versicherung}
\input{index}
