...
the multi-reference CI ansatz is used excessively.}.
\todoil{Cite MRCI review?}
...
\todoil{Cite paper for this and note that lr-CC is possible, too.}
...
\todoil{Mention CCSD(T) and linear-scaling CC}
