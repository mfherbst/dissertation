...
Some exemplary \FCI and {\MP}2 calculations have been performed
...
we employed \molsturm~(version 0.0.3)~\cite{molsturmWeb}
as well as its interfaces to \pyscf~(version 1.4.0)~\cite{Sun2017}
and \adcman~(version 2.5-core\_valence)~\cite{Wormit2014}.
