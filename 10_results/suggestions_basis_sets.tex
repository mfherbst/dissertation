...
% TODO OPTIONAL
%      Table of optimal values for k per basis set.
...
which is very much related to the Schrödinger equation for hydrogen-like atoms.
Most importantly the angular part of both the Coulomb-Sturmian
as well as the solution to the hydrogen-like problem (see section \vref{sec:HydrogenAtom})
...
from the chemical and physical behaviour, even though this has not been taken
