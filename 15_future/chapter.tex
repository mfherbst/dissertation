...
\todo[caption={},inline]{
	...
	\begin{itemize}
		\item \molsturm easy to extend
		\item lazy tensors are more than just high-level syntax
		\item They are also decisions about computation taken at runtime
		\item and avoiding the need to store anything
	\end{itemize}
}
